...
<body>
    <h2 style="margin-left:10rem; margin-top:5rem;">View Students</h2> 
    ...
    <?php
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            // End table
            echo "</table>";
            echo "<button onclick=\"location.href='add_student.php'\" style=\"margin-left:10rem; margin-top:1rem;\">Add Student</button>";
