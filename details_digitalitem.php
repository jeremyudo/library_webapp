...
<div class="detailsContainer">
    ...
    if(isset($_GET['digitalid'])) {
        ...
        if(mysqli_num_rows($result) > 0) {
            ...
            // Check if the digital item is already checked out by the student
            ...
            if(mysqli_num_rows($checkoutResult) > 0) {
                // If already checked out, display "Check In" button
                ?>
                ...
                // If not checked out, display "Check Out" button
                ?>
