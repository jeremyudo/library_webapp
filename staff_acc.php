...
<link rel="stylesheet" href="/staffacc.css">
</head>
<body>
  ...
  <div class="topBar">
    <div class="welcomeBox">
      ...
      if(isset($_SESSION['IsStaff']) && $_SESSION['IsStaff'] === true) {
          // Display the staff member's name
          echo '<h1 class="welcome">Welcome to Our Library, ' . $_SESSION['FirstName'] . ' ' . $_SESSION['LastName'] . '</h1>';
      } else {
          // Display a generic welcome message for students
          echo '<h1 class="welcome">Welcome to Our Library</h1>';
      }
        ?>
